		...
		,	getContext: function ()
			{
				...
				,	pageHeader: this.page_header
					//@property {Boolean} freeShippingLogo
				...
				,	freeWhitegloveLogo: item_model.attributes.custitemfreewhiteglovelogo
					//@property {Boolean} freeCurbsideLogo
				,	freeCurbsideLogo: item_model.attributes.custitemfreecurbsidelogo
					//@property {Boolean} bulkItemsLogo
				,	bulkItemsLogo: item_model.attributes.custitembulkitemslogo
					//@property {Boolean} freeLocalLogo
				,	freeLocalLogo: item_model.attributes.custitemfreelocallogo
					//@property {Boolean} crashTestedLogo
				,	crashTestedLogo: item_model.attributes.custitemcrashtestedlogo
					//@property {Boolean} adaCompliantLogo
				,	adaCompliantLogo: item_model.attributes.custitemadacompliantlogo
